/*
	-	Derived from p69_ACopy
	- 	Prints a string that I think refers to the memory location of array objects
...
class Unexpected1 {
  public static void main(String[] args) {
    ...
    for(i=0; i<nums2.length; i++)
      System.out.print(nums2 + " "); // this is the line that causes the unexpected error
  }
}
